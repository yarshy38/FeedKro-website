...
const CustomizeCard = ({ att1, att2, att3, att4, att5, att6, att7, attb1, attb2, attb3, gap , image , noimage, link }) => {
    ...
    return (
        <>
            {currentProducts.map((e) => (
                <div key={e.id} className={`flex xl:gap-12 2xl:gap-${gap ? gap : "24"} items-center bg-white  rounded-2xl mx-10 mt-10`}>
                    <div>
                        {
                            noimage ? "" :          
