        ...
        <>
            <div className='flex flex-row justify-between mt-8 mb-12 pl-14'>
                <div className='flex flex-row justify-center items-center'>
                    ...
                    <Link to='/partner/custompartner' className="mr-5 text-[#43A0AF] text-xl font-medium opacity-[50%] flex flex-row items-center">
                        <FaGreaterThan size={15} className='mx-2' />C.P Customer Partners</Link>
                        <Link to='/partner/cpaffiliates' className="mr-5 text-[#43A0AF] text-xl font-medium opacity-[50%] flex flex-row items-center">
                        <FaGreaterThan size={15} className='mx-2' />C.P Affiliates</Link>
                        <Link to='/partner/affiliatesorder' className="mr-5 text-[#43A0AF] text-xl font-medium opacity-[50%] flex flex-row items-center">
                        <FaGreaterThan size={15} className='mx-2' />C.P Affiliates Orders</Link>
                    <Link className="mr-5 text-[#43A0AF] text-xl font-medium opacity-[100%] flex flex-row items-center">
                        <FaGreaterThan size={15} className='mx-2' />C.P Affiliates Order details</Link>
                </div>
            </div>
...
export default CpAffiliateOrderDetail