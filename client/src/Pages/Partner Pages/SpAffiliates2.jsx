    ...
    <>
      <div className="flex flex-row justify-between mt-8 mx-10">
        <div className="flex flex-row justify-center items-center">
          ...
          >
            <FaGreaterThan size={15} className="mx-2" /> Live Status
          </Link>
          <Link
            to="/partner/primesalepartner"
            className="mr-5 text-[#43A0AF] text-xl font-medium opacity-[50%] flex flex-row items-center"
          >
            <FaGreaterThan size={15} className="mx-2" />
            S.P' Prime Sale Partners
          </Link>
      ...
      <h1 className="text-2xl text-[#000000] font-medium mt-12 px-16">
        Sale Partner's Affiliate Details
      </h1>
      ...
      <h1 className="text-2xl text-[#000000] font-medium mt-12 mb-8 px-12">
        Total affiliates of this Partner
      </h1>
      {rowData &&
        rowData.map(() => (
          <div className="box bg-[#FFFFFF] w-[95%] h-[105px] mb-4 flex flex-row justify-between items-center mx-auto rounded-xl px-6">
