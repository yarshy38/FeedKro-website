        ...
        <>
            <div className='flex justify-between mx-10 mt-7'>
                <div className='flex space-x-9 items-center'>
                    ...
                    <Link to='/partner/partnersupport' className={`${location.pathname === '/customer' ? 'text-black' : 'text-[#43A0AF]'} opacity-50 text-xl font-bold gap-2 flex items-center`}><FaGreaterThan size={17} />Support</Link>
                    <Link className={`${location.pathname === '/chat' ? 'text-black' : 'text-[#43A0AF]'} text-xl font-bold gap-2 flex items-center`}><FaGreaterThan size={17} />  Chat</Link>
                </div>
            </div>
