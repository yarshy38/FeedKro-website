...
import VendorCard from '../components/All Categories/VendorCard';
    ...
    <>
      <div className='flex justify-between mx-10 mt-7'>
        <div className='flex space-x-9 items-center'>
          <Link Link to='/vendor' className="text-2xl font-bold opacity-50 text-[#7640AC]">Vendor Dashboard</Link>
          <Link Link to='/vendor' className="text-2xl font-bold opacity-50 text-[#7640AC] gap-2 flex items-center"><FaGreaterThan size={17} />Listed Products</Link>
          <Link className="text-2xl font-bold gap-2 flex items-center text-[#7640AC]"><FaGreaterThan size={17} />Live Products</Link> 
     </div>
