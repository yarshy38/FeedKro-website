    ...
    <>
      <div className='flex justify-between mx-10 mt-7'>
        <div className='flex space-x-9 items-center'>
          ...
          <Link className="text-2xl text-[#7640AC] font-bold gap-2 flex items-center"><FaGreaterThan size={17} />Batch Updates</Link> 
     </div>
      ...
      <div className='mt-10'>
        <CustomizeCard att1={'Product ID'} att2={"Product Name"} att3={'Vendor ID'} att4={"Date"} att5={"Newly Items Added"} attb1={"New Batch No"} attb2={'Product Details'}
        link={'vendor-update-details'}
        />
      </div>
...
export default VendorBatchUpdate