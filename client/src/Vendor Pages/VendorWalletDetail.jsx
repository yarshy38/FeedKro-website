    ...
    <>
      <div className="flex flex-row justify-between mt-8 mx-10">
        <div className="flex flex-row justify-center items-center">
          ...
          <Link
            ...
            className="mr-5 text-[#7640AC] text-xl font-bold opacity-[50%] flex flex-row items-center"
          >
      ...
      <div className="mt-12 flex flex-col justify-center items-center">
        <img
          ...
          alt="image"
        />
        <h1 className="text-[#444444] text-2xl font-medium opacity-[100%] pt-4 text-center">
          Name of Vender
        </h1>
      </div>
      ...
      <h1 className="text-2xl text-[#444444] font-medium mt-8 mb-12 px-16">
        Transaction History
      </h1>
      {rowData &&
        rowData.map(() => (
