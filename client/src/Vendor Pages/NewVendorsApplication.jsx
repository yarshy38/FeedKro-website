    ...
    <>
      <div className='flex justify-between mx-10 mt-7'>
        <div className='flex space-x-9 items-center'>
          ...
          <Link to='/vendor/new-vendors' className="text-2xl font-bold text-[#7640AC] gap-2 flex items-center"><FaGreaterThan size={17} />New Venders Application</Link> 
     </div>
      ...
      <div className='mt-10'>
        <CustomizeCard  noimage={1} gap={36} att1={'Name'} att2={"CNIC NO "} att3={'Contact NO '} att4={"Email"} att6={"Password"} att7={"Location"}  attb2={'Detail'}
        link={'vendor-app-details'}
        />
      </div>
...
export default NewVendorApplication