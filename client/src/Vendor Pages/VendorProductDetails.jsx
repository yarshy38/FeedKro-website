  ...
  return (
    <>
      <div className='flex space-x-9 items-center mt-7 mx-20'>
        <Link to='/vendor' className="text-2xl font-bold opacity-50 text-[#7640AC]">Customer Dashboard</Link>
        <Link to='/vendor' className="text-2xl font-bold opacity-50 text-[#7640AC] gap-2 flex items-center"><FaGreaterThan size={17} />Listed Product</Link>
        <Link to='/vendor/live-products' className="text-2xl font-bold opacity-50 text-[#7640AC] gap-2 flex items-center"><FaGreaterThan size={17} />Live Products</Link>
        <Link className="text-2xl font-bold gap-2 flex items-center text-[#7640AC]"><FaGreaterThan size={17} /> Product Details</Link>
      </div>
