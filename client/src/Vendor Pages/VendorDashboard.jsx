...
export default function VendorDashboard() {
    ...
    const [listedProductsOpen, setListedProductsOpen] = useState(false);
    ...
    const handleListedProductsToggle = () => {
      setListedProductsOpen(!listedProductsOpen);
    };
          ...
          <>
            <div className="bg-white ps-4 pe-10 pt-20 pb-10 absolute -right-12 -top-16 text-black z-10 shadow-lg">
              ...
              <div
                ...
                onClick={handleListedProductsToggle}
              >
                <span>
                  <RiHomeSmileLine />
                </span>
              ...
              {isVendorOpen && (
                <div className="pl-8 mt-2 text-base">
                  <div className="flex flex-col gap-3 mt-3">
                    <Link
                    to="registered"
                    >Registered Vendor's</Link>
                    <Link
                    to="new-vendors"
                    >New Vendor Applications</Link>
                  </div>
                </div>
              )}
              ...
              {isNotificationOpen && (
                <div className="pl-8 mt-2 text-base">
                  <div className="flex flex-col gap-3 mt-3">
                    <Link
                    to="vendornotification"
                    >All Notification</Link>
                    <Link
                    to="vendornewnotification"
