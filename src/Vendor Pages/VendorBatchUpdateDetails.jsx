...
const VendorBatchUpdateDetails = () => {
  return (
    <>
      <div className='flex space-x-9 items-center mt-7 mx-20'>
        ...
        <Link to='/vendor/batch-update' className="text-2xl font-bold opacity-50 text-[#7640AC] gap-2 flex items-center"><FaGreaterThan size={17} />Batch Updates</Link>
        <Link className="text-2xl font-bold gap-2 flex items-center text-[#7640AC]"><FaGreaterThan size={17} />Batch Updates Details</Link>
      </div>
...
export default VendorBatchUpdateDetails