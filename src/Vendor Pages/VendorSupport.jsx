        ...
        <>
            <div className='flex justify-between mx-10 mt-7'>
                <div className='flex space-x-9 items-center'>
                    ...
                    <Link to='/customer' className={`${location.pathname === '/customer' ? 'text-black' : 'text-[#7737B6]'} text-xl font-bold gap-2 flex items-center`}><FaGreaterThan size={17} /> Support</Link>
