    ...
    <>
      <div className='flex justify-between mx-10 mt-7'>
        <div className='flex space-x-9 items-center'>
          ...
          <Link className="text-2xl font-bold gap-2 flex items-center text-[#7640AC]"><FaGreaterThan size={17} />New Products</Link> 
     </div>
      ...
      <div className='mt-10'>
        <CustomizeCard att1={'Product Name'} att2={"Vendor ID"} att3={'Vendor Name'} att4={"Date"} att5={"Total No Of Items"} attb2={'Product Details'} gap={28} />
      </div>
...
export default VendorNewProducts