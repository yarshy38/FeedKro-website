...
const Support = () => {
        ...
        <>
            <div className='flex justify-between mx-10 mt-7'>
                <div className='flex space-x-9 items-center'>
                    <Link to='/rider/dashboard' className="text-xl font-bold opacity-50 text-[#7737B6]">Rider Dashboard</Link>
                    <Link className={`${location.pathname === '/customer' ? 'text-black' : 'text-[#7737B6]'} text-xl font-bold gap-2 flex items-center`}><FaGreaterThan size={17} /> Support</Link>
    ...
    h-[107px] flex items-center">
       <div class=" w-[100%] flex  justify-around px-4 ">
           ...
           <ul>
               <li class="flex justify-center font-bold mb-2 ">Rider ID</li>
               <li class="flex justify-center">C1234</li>
           </ul>
           <ul>
               <li class="flex justify-center font-bold mb-2  ">Rider Name</li>
