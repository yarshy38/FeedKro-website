...
const CpAffiliates = () => {
    ...
    return (
        <>
            ...
            <h1 className="text-2xl text-[#000000] font-medium mt-12 px-16">Customer's Affiliate Details</h1>
                ...
                <div className="flex flex-row justify-between items-center w-[45%]">
                    ...
                    <div>
                        <ul className="text-[#000000] font-medium">
                            ...
                            <li className="pb-1 text-[#FE5555]">FCP</li>
                        </ul>
                    </div>
                </div>
                <div className="flex flex-row justify-between items-center w-[45%]">
            ...
            <h1 className="text-2xl text-[#000000] font-medium mt-12 mb-8 px-12">Total affiliates of this customer</h1>
            {rowData && rowData.map(() => (
