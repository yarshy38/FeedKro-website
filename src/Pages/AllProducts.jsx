...
import AllProductsCard from '../components/All Categories/AllProductsCard';
    ...
    <>
      <div className='flex justify-between mx-10 mt-7'>
        <div className='flex space-x-9 items-center'>
          ...
          <Link className="text-2xl font-bold gap-2 flex items-center"><FaGreaterThan size={17} />All Products</Link> 
     </div>
